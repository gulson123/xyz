...
<h1> MOJOJO <br>
<span>Everyone's Personal Stylist</span> </h1>
</div>
<div class="banner-txt-right">
<p class="txt-1"> Everyone's Personal Stylist</p>
</div>
</div>
<div class="nav-area">
<ul class="navigation">
...
<div class="mid-left">
<h2 style=" padding: 20px 0px 5px 30px;">WHY <span>MOJOJO?</span></h2>
<p class="txt-2" style="font family:Comic Sans MS;padding: 10px 0px 5px 30px;"> Remember those days of getting a bizarre hair cut from a stylist, which made you look for another new salon? Or searching for “best salons nearby” on web and failed to get accurate results? Well, We're here to help make sure those are behind us.

Making the right choices with your beauty & wellness services isn't easy. It's hard to know where to look to get inspired, to find all the current trends and to pick a style that'll suit you. And if you do, finding the right stylist at the right salon to re-create the look is often left to chance.</p>
<ul class="item-1">
...
<div style="padding: 10px 0px 10px 54px;"><img src="images/pict-2.jpg" alt="#" border="0" width="189px" height="99px"></div>
